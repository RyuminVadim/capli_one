...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.noise_check.sizePolicy().hasHeightForWidth())
        self.noise_check.setSizePolicy(sizePolicy)
        self.noise_check.setObjectName("noise_check")
        self.horizontalLayout_11.addWidget(self.noise_check)
        self.noise_check_false = QtWidgets.QCheckBox(self.verticalLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.noise_check_false.sizePolicy().hasHeightForWidth())
        self.noise_check_false.setSizePolicy(sizePolicy)
        self.noise_check_false.setObjectName("noise_check_false")
        self.horizontalLayout_11.addWidget(self.noise_check_false)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dilate_check.sizePolicy().hasHeightForWidth())
        self.dilate_check.setSizePolicy(sizePolicy)
        self.dilate_check.setObjectName("dilate_check")
        self.horizontalLayout_10.addWidget(self.dilate_check)
        self.dilate_check_false = QtWidgets.QCheckBox(self.verticalLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dilate_check_false.sizePolicy().hasHeightForWidth())
        self.dilate_check_false.setSizePolicy(sizePolicy)
        self.dilate_check_false.setObjectName("dilate_check_false")
        self.horizontalLayout_10.addWidget(self.dilate_check_false)
        ...
        self.dilate_h.setProperty("value", 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Capli"))
        ...
        self.filter.setItemText(0, _translate("MainWindow", "Gaussian Blur"))
        self.filter.setItemText(1, _translate("MainWindow", "Adaptive Threshold"))
        ...
        self.noise_check_false.setText(_translate("MainWindow", "Не применять"))
        ...
        self.dilate_check_false.setText(_translate("MainWindow", "Не применять"))
